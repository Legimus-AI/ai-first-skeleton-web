	...
	return (
		<input
			...
			className={cn(
				...
				'dark:aether-input-inset dark:border-[rgba(255,255,255,0.08)] dark:focus-visible:border-[rgba(255,255,255,0.5)] dark:focus-visible:shadow-[inset_0_1px_4px_rgba(255,255,255,0.06)]',
				error &&
